        ...
        <div className = { className1 }>
            ...
            <div className = "mb-2 relative">
                <div className = "relative">
                    ...
                    <div className = "absolute cursor-pointer inset-y-0 right-0 px-3 flex items-center text-sm border-l-0 leading-5 dark:bg-gray-700 dark:text-gray-200 border border-gray-300 dark:border-gray-600 bg-gray-100" onClick = {passVisibilityHandler}>
                        { display && <span> <FontAwesomeIcon icon = { faEyeSlash }></FontAwesomeIcon> </span> }
                        { !display && <span> <FontAwesomeIcon icon = { faEye }></FontAwesomeIcon> </span> }
                    </div>
                </div>
            </div>
        </div>
