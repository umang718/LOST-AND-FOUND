  ...
  return (
    <div>
      ...
      <hr/>
                ...
                Found Location: <Input label="Location" placeholder="Location" />
                Enter a question based on item (For verification purpose): <Textarea placeholder = "Say, What is the color of the item found?" row = "1" />
